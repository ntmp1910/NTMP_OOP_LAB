        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    Media existingCD = store.searchMedia(cd.title);
                    if (existingCD == null) {
                        store.addMedia(cd);
                ...
                case 2:
                    ...
                    Media existingDVD = store.searchMedia(dvd.title);
                    if (existingDVD == null) {
                        store.addMedia(dvd);
                ...
                case 3:
                    ...
                    Book book = new Book(1,title, category, author, cost, token);
                    Media existingBook = store.searchMedia(book.title);
